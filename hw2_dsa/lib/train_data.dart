...
Future getTrainData(String path) {
  ...
  .then((List<String> data) {
    ...
    return Future.forEach(data, 
      (e) => _handleData(e)
      .then((Point9 point) => _trainData.add(point)));
  })
  .then((_) => new Future.value(_trainData));
}

Future<Point9> _handleData(String pointStr) {
  int start = 0;
  ...
  return new Future.value(new Point9(x, y));
}